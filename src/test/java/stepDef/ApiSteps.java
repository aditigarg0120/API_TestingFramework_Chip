...
public class ApiSteps extends Base {
    ...
    @When("I replaced {string} to profanity list")
    public void i_replaced_to_profanity_list_using(String text) {
        setQueryParameter(Constants.FILL_TEXT,text);
        getResponse();
    }

    @When("I add {string} with exceed limit text {string} to profanity list")
    @When("I add {string} with replaced text {string} to profanity list")
    ...
    @When("I add {string} with replaced char {string} to profanity list")
    public void i_replaced_char_to_profanity_list_using(String add_text,String replaced_char) {
        setQueryParameter(Constants.ADD,add_text);
        setQueryParameter(Constants.FILL_CHAR,replaced_char);
        getResponse();
    }
